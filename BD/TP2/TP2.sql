...
-- Lister les noms et les pr´enoms des coureurs.
...
-- Donner les noms des coureurs de l’´equipe COFIDIS.
select NomCoureur 
from COUREURS 
...
-- Quel temps le coureur ’JALABERT’ a fait dans l’´etape 3 ?
select TempsRealise 
from TEMPS natural join CO
