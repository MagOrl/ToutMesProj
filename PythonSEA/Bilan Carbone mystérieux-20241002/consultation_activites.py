...
def programme_principal():
    ...
    liste_info =["Recherche par nom(1)",
                 ...
                 "Fusion de listes(2)","Recherche dichitomique(1)"]
    saved = {}
    quitter = False 
    while not quitter:
        ...
        if rep == 1:
            ...
            print("Vous avez choisi : [", liste_options[repinfo - 1],"]")
            if repinfo == 1:
                if len(saved) != 0:
            ...
            if len(saved) == 0:
                ...
                for keys,valeur in saved.items():
                    if kle == keys:
                        ...
                        print("Veuillez mettre un bon nom de clef")
                        pass            
        if rep == 3:
            print("Voici les listes sauvegardées :")
            for keys, value in saved.items():
                print(f"{keys}")
