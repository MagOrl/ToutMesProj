...
def test_max_emmission():
    ...
    assert bc.max_emmission([('David', '2024-09-29', 23, 'type4')]) == ('David', '2024-09-29', 23, 'type4')
...
def test_plus_longue_periode_emmissions_decroissantes():
    ...
    assert bc.plus_longue_periode_emmissions_decroissantes(None) == None
...
def test_est_bien_triee():
    ...
    assert bc.est_bien_triee(bc.liste2) == True
...
def test_fusionner_activites():
    ...
    assert bc.fusionner_activites(bc.liste1, []) == bc.liste1
...
def test_recherche_activite_dichotomique():
    ...
    assert bc.recherche_activite_dichotomique('', '', '', [('Lucas', '2024-09-01', 67.2, 'type3'), ('Lucas', '2024-09-02', 70.08, 'type3')]) == None
...
def test_cumul_temps_activite():
    ...
    assert bc.cumul_temps_activite([],bc.co2_minute) == 0 
    assert bc.cumul_temps_activite([('Lucas', '2024-09-01', 67.2, 'type3'),('Lucas', '2024-09-02', 67.2, 'type3')],bc.co2_minute) == 67.2/0.96
# ---------------------------------------------------------------------------------------------
